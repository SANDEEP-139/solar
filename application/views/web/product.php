      ...
      <div id="content" class="full-width">
        <div id="post-1701" class="post-1701 page type-page status-publish hentry"> <span class="vcard" style="display: none;"><span class="fn"><a href="../author/admin/index.html" title="Posts by admin" rel="author">admin</a></span></span><span class="updated" style="display:none;">2017-05-06T10:36:22+00:00</span>
          <div class="post-content">
            <div class="fusion-fullwidth fullwidth-box fusion-fullwidth-1  fusion-parallax-none" style="border-color:#eae9e9;border-bottom-width: 0px;border-top-width: 0px;border-bottom-style: solid;border-top-style: solid;padding-bottom:20px;padding-left:0px;padding-right:0px;padding-top:16px;background-color:#03942c;background-position:left top;background-repeat:no-repeat;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover;">
              ...
              <div class="fusion-row">
                <h1 style="text-align: center;"><span style="color: #ffffff;">Solar Panel  : <?= $productd['heading']?></span></h1>
                ...
                foreach ($singleslider as $valuess) {?>
                  <img src="<?= base_url('images/').$valuess['image'];?>" alt="Zcolour Interior" class="img-responsive" style="height: 343px;border:4px solid #ffffff;-moz-box-shadow: 0 0 3px rgba(160,214,122,.3);-webkit-box-shadow: 0 0 3px rgba(160,214,122,.3);box-shadow: 0 0 3px rgba(160,214,122,.3);"/></span></div>
                <?php }}else{}?>
...
.fusion-fullwidth-2 {
              ...
              <div class="fusion-row"><script src="../../app.anyguide.com/assets/integration-v1.1.js"></script>
                ...
                <h2 style="text-align: center;" data-fontsize="60" data-lineheight="60"><strong>Solar Panel <?= $productd['heading']?> Project in Lucknow</strong></h2>
                <div class="fusion-sep-clear"></div>
                <div class="fusion-separator sep-single" style="border-color:#000000;border-top-width:1px;margin-left: auto;margin-right: auto;margin-top:px;margin-bottom:40px;width:100%;max-width:170px;"></div>
                <div class="row">
                <?php if(!empty($slider)){
