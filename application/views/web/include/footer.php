      ...
      <div class="fusion-columns fusion-columns-4 fusion-widget-area">
            ...
            <div class="menu-main-menu-container">
              ...
              <ul id="menu-main-menu-2" class="menu">
                ...
                <ul>
                  ...
                  <h4 class="footer-heading"><a href="#">Projects</a> </h4>
        ...
        <div class="fusion-column col-lg-3 col-md-3 col-sm-3">
          ...
          <ul>
              ...
              <h4 class="footer-heading"><i style="background-color:transparent;border-color:transparent;height:auto;width:25px;line-height:normal;color:#ffffff;font-size:25px;" ></i><img src="images/add.png"/><a href="#">Address</a></h4>

              <li><a href="#" ><address><?= $setting['p_address'];?></address></a></li>

                  <li><img src="images/phone.png"/><a href="#"> <address>Phone: +91-<?= $setting['phoneno'];?></address></a></li>

                  <li><img src="images/email.png"/><a href="#"><address>Email: <?= $setting['emailid'];?></address></a></li>
    ...
    <div class="fusion-row">
      ...
      <div class="fusion-copyright-content">
        ...
        <div class="fusion-copyright-notice">
          ...
          <div>Copyright 2019 <?= $setting['cname'];?>|&nbsp;All Rights Reserved</div>
