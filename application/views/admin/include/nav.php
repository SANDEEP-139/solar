    ...
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="<?= base_url('Admin/Dashboard');?>">
                <img class="img-fluid" src="<?= base_url('images/newlogo.png');?>" style="height: 35px;" alt="Theme-Logo" />
            </a>
        ...
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                ...
                <li class="pcoded-hasmenu ">
                        <a href="javascript:void(0)">
                            <span class="pcoded-micon"><i class="ti-layout-cta-btn-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.task.main">Services Details</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                      <ul class="pcoded-submenu">
                            <li class="">
                                <a href="<?= base_url('Admin/Services');?>">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.task.task-list">Services Details</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                        </ul>
                ...
                <li class="pcoded-hasmenu ">
                        <a href="javascript:void(0)">
                            <span class="pcoded-micon"><i class="ti-layout-cta-btn-right"></i></span>
                            <span class="pcoded-mtext" data-i18n="nav.task.main">Gallery Details</span>
                            <span class="pcoded-mcaret"></span>
                        </a>
                      <ul class="pcoded-submenu">
                            <li class="">
                                <a href="<?= base_url('Admin/Gallery');?>">
                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                    <span class="pcoded-mtext" data-i18n="nav.task.task-list">Gallery Details</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                            </li>
                        </ul>
