                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a class="btn btn-danger waves-effect waves-light f-right d-inline-block md-trigger" href="<?= base_url('Admin/Gallery');?>"><span>Gallery View</span></a>
                                  </div>
                                <div class="card-block">
                                      <form method="post" action="<?php echo base_url('Admin/Gallery/clientupd?id=').$data['id']; ?>" enctype='multipart/form-data'>
